    ...
    public class INIDataManager
    {
        ...
        public bool FindINI()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Please save the current Revit project file before start using the BCFReader.", "File Not Saved", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
