...
namespace HOK.SmartBCF.Utils
{
    public class ModelInfo
    {
        ...
        private bool externalUser = false;
        private string googleFolderId = "";
        private string googleFolderTitle = "";
        ...
        public bool ExternalUser { get { return externalUser; } set { externalUser = value; } }
        public string GoogleFolderId { get { return googleFolderId; } set { googleFolderId = value; } }
        public string GoogleFolderTitle { get { return googleFolderTitle; } set { googleFolderTitle = value; } } //project info
        public string WebViewLink { get { return webViewLink; } set { webViewLink = value; } } //project info
        ...
        private void GetProjectInfo()
        {
            if (!string.IsNullOrEmpty(docCentralPath))
            {
                ...
                {
                    hokStandard = true;
                    googleFolderTitle = projectNumber +" " + projectName;
                }
