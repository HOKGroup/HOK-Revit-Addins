...
public partial class ColorScheme {
    ...
    private List<Element> filteredElements = new List<Element>();
    ...
    private ParameterInfo selectedParamInfo = new ParameterInfo();

    private ViewInfo selectedViewInfo = new ViewInfo();

    private bool includeLinks = false;

    private List<ColorDefinition> customColorDefinitions = new List<ColorDefinition>();
    ...
    public ParameterInfo SelectedParamInfo
    {
        get { return selectedParamInfo; }
        set { selectedParamInfo = value; }
    }
    ...
    [System.Xml.Serialization.XmlIgnore]
    public List<Element> FilteredElements
    {
        get { return filteredElements; }
        set { this.filteredElements = value; }
    }
    ...
    [System.Xml.Serialization.XmlIgnore]
    public ViewInfo SelectedViewInfo
    {
        get { return selectedViewInfo; }
        set { selectedViewInfo = value; }
    }
    ...
    [System.Xml.Serialization.XmlIgnore]
    public List<ColorDefinition> CustomColorDefinitions
    {
        get { return this.customColorDefinitions; }
        set { this.customColorDefinitions = value; }
    }
