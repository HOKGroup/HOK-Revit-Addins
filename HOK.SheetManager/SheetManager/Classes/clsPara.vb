...
''' <summary>
''' Defines a parameter of Element 
''' </summary>
''' <remarks></remarks>
...
#End If
    ...
    ''' <summary>
    ''' The parameter reference. The element the parameter belongs to is accessible from this object
    ''' </summary>
    ''' <value></value>
