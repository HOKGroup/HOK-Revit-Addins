...
namespace HOK.RoomsToMass
{
    public class AppCommand:IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            if (null != assembly.GetType("HOK.RoomsToMass.Command"))
            {
            ...
            if (null != assembly.GetType("HOK.RoomsToMass.DataCommand"))
            {
            ...
            if (null != assembly.GetType("HOK.RoomsToMass.AssignerCommand"))
            {
