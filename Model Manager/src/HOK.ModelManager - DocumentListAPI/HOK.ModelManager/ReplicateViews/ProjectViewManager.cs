...
namespace HOK.ModelManager.ReplicateViews
{
    public class ProjectViewManager
    {
        ...
        public bool UpdateGoogleDoc(string recipientDoc, List<LinkInfo> updatingLinks, List<LinkInfo> deletingLinks, Dictionary<int, ViewProperties> removeMissingItems)
        {
            bool result = false;
            try
            {
                ...
                bool deleted = googleDocsUtil.DeleteLinkInfo(googleDocInfo.SheetEntry, deletingLinks, removeMissingItems);
