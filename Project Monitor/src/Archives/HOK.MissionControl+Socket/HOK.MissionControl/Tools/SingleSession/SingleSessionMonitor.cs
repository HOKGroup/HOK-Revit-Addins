...
namespace HOK.MissionControl.Tools.SingleSession
{
    public static class SingleSessionMonitor
    {
        ...
        private static Dictionary<string, Document> openedDocuments = new Dictionary<string, Document>();
        ...
        public static Dictionary<string, Document> OpenedDocuments { get { return openedDocuments; } set { openedDocuments = value; } }
        ...
        public static void CloseFile(string centralFile)
        {
            try
            {
                if (openedDocuments.ContainsKey(centralFile))
                {
