...
namespace HOK.SheetDataManager
{
                ...
                if (null != configSchema)
                {
                    ...
                    if (savedStorage.Count > 0)
                    {
                        using (Transaction trans = new Transaction(doc))
                        {
                            ...
                            {
                                trans.RollBack();
                                MessageBox.Show("Failed to delete storage for Sheet Manager configuration.\n" + ex.Message, "Sheet Manager Configuration", MessageBoxButton.OK, MessageBoxImage.Warning);
                            }
                        }
                    }
                    ...
                    using (Transaction trans = new Transaction(doc))
                    {
                        ...
                        {
                            trans.RollBack();
                            MessageBox.Show("Failed to save Sheet Manager configuration.\n" + ex.Message, "Sheet Manager Configuration", MessageBoxButton.OK, MessageBoxImage.Warning);
                        }
                    }
                }
            }
    ...
    public class SheetManagerConfiguration
    {
        ...
        public Guid ModelId { get { return modelId; } set { modelId = value; } }
        public string CentralPath { get { return centralPath; } set { centralPath = value; } }
        public string DatabaseFile { get { return databaseFile; } set { databaseFile = value; } }
        public ElementId TitleblockId { get { return titleblockId; } set { titleblockId = value; } }
