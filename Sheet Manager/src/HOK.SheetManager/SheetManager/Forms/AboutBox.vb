Public NotInheritable Class AboutBox
    ...
    Private Sub linkContact_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles linkContact.LinkClicked
        ...
        Dim folderInbox As Microsoft.Office.Interop.Outlook.Folder = name.GetDefaultFolder(Microsoft.Office.Interop.Outlook.OlDefaultFolders.olFolderInbox)
        Dim mailItem As Microsoft.Office.Interop.Outlook.MailItem = outlookApplication.CreateItem(Microsoft.Office.Interop.Outlook.OlItemType.olMailItem)
