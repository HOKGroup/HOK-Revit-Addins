$regexToDelete = "^([.|_]\w+)|HOK.AddInManager|Utility Tools|HOK.BetaToolsManager|HOK.Core|HOK.Feedback|LPD Calculator|HOK.MissionControl|Model Reporting|HOK.MoveBackup|Navigator|Mass Tools|Sheet Manager|Smart BCF|AVF Manager|Parameter Tools|Element Tools|HOK.RibbonTab"
