...
If ($Env:BUILD_ENV -eq 'AzureDevOps') {
    ...
    &"C:\Program Files (x86)\Windows Kits\10\bin\10.0.18362.0\x86\signtool.exe" sign /c '2022 Code Signing - DTM ' /t http://timestamp.comodoca.com/authenticode $DLL_PATH
}
